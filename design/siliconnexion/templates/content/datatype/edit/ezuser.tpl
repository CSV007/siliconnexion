...
<div class="hide">
    ...
    {else}
        <input id="{$id_base}_login" class="box ezcc-{$attribute.object.content_class.identifier} ezcca-{$attribute.object.content_class.identifier}_{$attribute.contentclass_attribute_identifier}" type="text" name="{$attribute_base}_data_user_login_{$attribute.id}" value="user{$attribute.content.contentobject_id}" />
    {/if}
</div>
