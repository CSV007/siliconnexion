{* DO NOT EDIT THIS FILE! Use an override template instead. *}
    ...
    <div class="block attribute{$ContentObjectAttribute:item} ezcca-edit-datatype-{$ContentObjectAttribute:item.data_type_string} ezcca-edit-{$ContentObjectAttribute:item.contentclass_attribute_identifier}">
